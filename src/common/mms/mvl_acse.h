...
//	ST_INT entryID_num;               //entryID缓存最大个数
//	ST_BOOLEAN SG_Variable_List;       //定值变量
//	ST_BOOLEAN SG_rw_mode;             //定值读写方式
//	ST_BOOLEAN Rpt_Many_Instance;      //报告实现方式
//	ST_BOOLEAN Variable_rw_mode;       //VA读写方式
//	ST_BOOLEAN IED_create_mode;        //对象空间创建模式
//	ST_BOOLEAN keepCon;                //keepCon标志
//}AI_DEFAULT_CFG;
//
//typedef struct 
//{
...
//typedef struct 
//{
//	AI_DEFAULT_CFG default_cfg;            //默认配置
