...
extern detailedMessageView * exDetailedMessageView;
...
void QHexEdit::mousePressEvent(QMouseEvent * event)
{
    ...
    exDetailedMessageView->HexContrl2TreeControl((int)cPos/2);
}
...
void QHexEdit::setSelectionBegin(qint64 selectionBegin)
{
     _bSelectionBegin = selectionBegin;
}

void QHexEdit::setSelectionEnd(qint64 selectionEnd)
{
     _bSelectionEnd = selectionEnd;
}

void QHexEdit::setSelectionInit(qint64 selectionInit)
{
     _bSelectionInit = selectionInit;
}
